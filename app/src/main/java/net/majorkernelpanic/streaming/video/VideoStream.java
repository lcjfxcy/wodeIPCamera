...
import net.majorkernelpanic.spydroid.ui.PreviewFragment;
...
import net.majorkernelpanic.util.Progress;
...
public abstract class VideoStream extends MediaStream {
	 ...
	 */
	/*@Subscribe
	public void setZoom(Progress progress)
	{Camera.Parameters mparameters=mCamera.getParameters();
		mparameters.setZoom(progress.val);
		...
		if (mSurfaceView.getHolder() != null) {
			mSurfaceHolderCallback = new Callback() {
				...
				public void surfaceCreated(SurfaceHolder holder) {
					...
					setZoom(50);
					Log.d(TAG,"Surface created setZoom");
					/*EventBus.getDefault().register(SpydroidApplication.getMycontext());*/
				}
				...
				public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
					...
					setZoom(50);
					Log.d(TAG,"Surface Changed setZoom");
					/*EventBus.getDefault().register(SpydroidApplication.getMycontext());*/
					/*LayoutInflater flater=LayoutInflater.from(context);
					View view=flater.inflate(R.layout.preview,null);
					final SeekBar zoombar=(SeekBar)view.findViewById(R.id.mZoomBar);
					if (zoombar==null)
					{Log.v("aaaaaaaaaa","is null");}
	...
	protected void encodeWithMediaCodecMethod2() throws RuntimeException, IOException {
		...
		Log.d(TAG,"Video encoded using the MediaCodec API 2 with a surface");
	...
	protected synchronized void createCamera() throws RuntimeException {
		...
		setZoom(50);
		Log.d(TAG,"createCamera setzoom");
	}
	...
	protected synchronized void updateCamera() throws RuntimeException {
		...
		setZoom(50);
		Log.d(TAG,"updateCamera setzoom");
	}
